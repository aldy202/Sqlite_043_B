...
public class TambahTeman extends AppCompatActivity {
    ...
    private static String url_insert = "https://20200140043.praktikumtiumy.com/tambahtm.php";
    ...
    private void callHome(){
        Intent i = new Intent(TambahTeman.this, com.example.sqlite.MainActivity.class);
        startActivity(i);
        finish();
    }
